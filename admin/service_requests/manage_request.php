...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="category_id" class="control-label">Tipe Kendaraan</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">Merk Kendaraan</label>
                ...
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">Nomor Plat</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Model Transmisi</label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group " id="mechanic-holder">
                    <label for="mechanic_id" class="control-label">Mekanik :</label>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Simpan</button>
