...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Laporan Request Servis Kendaraan</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Laporan Request Servis</b></h3>
                <p class="text-center m-0">Tanggal antara <?php echo $date_start ?> dan <?php echo $date_end ?></p>
                <hr>
            </div>
